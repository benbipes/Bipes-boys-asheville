/**
 * Compact, standalone QR Code generator for JavaScript.
 * Generates QR Code matrices and SVG / Canvas outputs with zero dependencies.
 * Adapted from Kazuhiko Arase's QR Code Library (MIT).
 */
(function (root, factory) {
  ...
  return {
    generateSVG: function (text, options) {
      ...
      var fgColor = options.fgColor || '#1c1917';
      var bgColor = options.bgColor || '#ffffff';

      var qr = new QRCodeModel(0, 0); // auto type, M error correction
      qr.addData(text);
      qr.make();
      ...
      return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + viewBoxSize + ' ' + viewBoxSize + '" width="' + size + '" height="' + size + '" style="border-radius:12px;background:' + bgColor + ';display:block;margin:0 auto;">' +
